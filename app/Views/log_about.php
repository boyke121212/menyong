<div class="card shadow-sm">
        ...
        <div class="row g-2 align-items-center mb-2">
            ...
            <div class="col-md-3">
                <select id="actionFilter" class="form-control form-control-sm">
                    ...
                    <option value="CREATE_ABOUT">CREATE_ABOUT</option>
                    <option value="UPDATE_ABOUT">UPDATE_ABOUT</option>
                </select>
            </div>
        </div>
        <div class="row g-2">
    ...
    <div class="card-body log-table-wrap">
        <table id="logAboutTable" class="table table-bordered table-hover table-sm w-100">
...
$(document).ready(function() {
    ...
    let table = $('#logAboutTable').DataTable({
        processing: true,
        serverSide: true,
        responsive: true,
        ajax: {
            url: "<?= site_url('log_about/data') ?>",
            type: "POST",
            data: function(d) {
    ...
    $('#btnExport').on('click', function() {
        ...
        window.location.href = "<?= site_url('log_about/export') ?>?startDate=" + encodeURIComponent(s) +
