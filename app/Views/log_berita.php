<div class="card shadow-sm">
        ...
        <div class="row g-2 align-items-center mb-2">
            ...
            <div class="col-md-3">
                <select id="actionFilter" class="form-control form-control-sm">
                    ...
                    <option value="ADD_BERITA">ADD_BERITA</option>
                    <option value="EDIT_BERITA">EDIT_BERITA</option>
                    <option value="DELETE_BERITA">DELETE_BERITA</option>
                </select>
            </div>
        </div>
        <div class="row g-2">
    ...
    <div class="card-body log-table-wrap">
        <table id="logBeritaTable" class="table table-bordered table-hover table-sm w-100">
...
$(document).ready(function() {
    ...
    let table = $('#logBeritaTable').DataTable({
        processing: true,
        serverSide: true,
        responsive: true,
        ajax: {
            url: "<?= site_url('log_berita/data') ?>",
            type: "POST",
            data: function(d) {
        ...
        columns: [{
            ...
            },
            {
                ...
                render: function(data) {
                    return (data.targetBeritaId || '-') + ' / ' + (data.targetJudul || '-');
                }
            },
            {
                data: null,
    ...
    $('#btnExport').on('click', function() {
        ...
        window.location.href = "<?= site_url('log_berita/export') ?>?startDate=" + encodeURIComponent(s) +
