<div class="card shadow-sm">
        ...
        <div class="row g-2 align-items-center mb-2">
            ...
            <div class="col-md-3">
                <select id="actionFilter" class="form-control form-control-sm">
                    ...
                    <option value="CREATE_KANTOR">CREATE_KANTOR</option>
                    <option value="UPDATE_KANTOR">UPDATE_KANTOR</option>
                </select>
            </div>
        </div>
        <div class="row g-2">
            <div class="col-md-12 d-flex gap-2 justify-content-end">
                <button id="btnApply" class="btn btn-sm btn-primary">
                    Apply Filter
                </button>
                <button id="btnReset" class="btn btn-sm btn-secondary">
                    Reset
                </button>
    ...
    <div class="card-body log-table-wrap">
        <table id="logKantorTable" class="table table-bordered table-hover table-sm w-100">
...
$(document).ready(function() {
    ...
    let table = $('#logKantorTable').DataTable({
        processing: true,
        serverSide: true,
        responsive: true,
        ajax: {
            url: "<?= site_url('log_kantor/data') ?>",
            type: "POST",
            data: function(d) {
    ...
    $('#btnExport').on('click', function() {
        ...
        window.location.href = "<?= site_url('log_kantor/export') ?>?startDate=" + encodeURIComponent(s) +
