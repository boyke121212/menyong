<div class="card shadow-sm">
    ...
    <div class="card-body log-table-wrap">
        <table id="userManagementLogTable" class="table table-bordered table-hover table-sm w-100">
...
$(document).ready(function() {
    ...
    let table = $('#userManagementLogTable').DataTable({
        processing: true,
        serverSide: true,
        responsive: true,
        ajax: {
            url: "<?= site_url('user_management_log/data') ?>",
            type: "POST",
            data: function(d) {
        ...
        columns: [{
            ...
            },
            {
                ...
                render: function(data) {
                    return (data.targetUserId || '-') + ' / ' + (data.targetUsername || '-') + ' / ' + (data.targetName || '-');
                }
            },
            {
                data: null,
    ...
    $('#btnExport').on('click', function() {
        ...
        window.location.href = "<?= site_url('user_management_log/export') ?>?startDate=" + encodeURIComponent(s) +
